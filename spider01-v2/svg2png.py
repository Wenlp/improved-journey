# -*- coding: utf-8 -*-
"""
Created on Wed Oct 21 12:29:48 2020
...
svg_path = 'https://www.zhihu.com/equation?tex=D'
html = requests.get(svg_path,headers=headers)
with open('formula.svg','wb') as f:
    f.write(html.content)


svg2png(bytestring=html.content,write_to='output.png')